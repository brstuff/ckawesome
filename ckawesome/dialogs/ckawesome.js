...
CKEDITOR.dialog.add('ckawesomeDialog', function( editor ) {
    function getCKAwesomeIcons(selectList ){
        ...
        $.ajax({
            ...
            success: function(response) {
                var excludeStyles = [".fa.",".fa", ".fas", ".fab", ".fa-lg",".fa-1x",".fa-2x",".fa-3x",".fa-4x",".fa-5x",".fa-6x",".fa-7x",".fa-8x",".fa-9x",".fa-10x",".fa-fw",".fa-ul",".fa-ul>",".fa-li",".fa-border",".fa-pull-left",".fa-pull-right",".fa-spin",".fa-pulse",".fa-rotate-90",".fa-rotate-180",".fa-rotate-270",".fa-flip-horizontal",".fa-flip-vertical",".fa-stack",".fa-stack-1x",".fa-stack-2x",".fa-inverse"];
    ...
    return {
                ...
                elements: [
                    {
                        ...
                        validate: CKEDITOR.dialog.validate.notEmpty( "Icon cannot be empty." ),
                    ...
                    },
                    {
                        type: 'select',
                        id: 'ckawesomepro',
                        label: "If you're using the Pro version, you can choose your style modifier here",
                        validate: CKEDITOR.dialog.validate.notEmpty( "Pro option cannot be empty." ),
                        items: [['Not Using Pro', ''],[ 'Solid', 'fas'],['Regular', 'far'], ['Light', 'fal']], 'default' : ''
                    },
                    {
                        type: 'select',
                        id: 'textsize',
                        ...
                        onLoad: function (widget) {
                            getSelectionOptions(this, 8, 4, 16);
                        }
                    },
                    {
                        type: "hbox",
                    ...
                    },
                    {
                        ...
                        validate: CKEDITOR.dialog.validate.notEmpty( "Alignment cannot be empty." ),
                        items: [[ 'Normal', 'unset'], ['Middle', 'middle']], 'default' : 'unset' ,
                    }
                ]
            },
        ],
        onOk: function() {
            ...
            var cka_alignment = dialog.getValueOf( 'options', 'alignment' );
            var cka_class = "fa fa-fw " + dialog.getValueOf( 'options', 'ckawesomebox' ) + " " + dialog.getValueOf( 'options', 'ckawesomepro' );
            var cka_style = ( cka_size != '' ? 'font-size: '+cka_size+'px;' : '' ) + ( cka_color != '' ? 'color: '+cka_color+';' : '' ) + ( cka_alignment != '' ? 'vertical-align: '+cka_alignment+';' : '' ) ;
